...
function Clock() {
    ...
    const month = actualDate && actualDate.toString().split(' ')[1]
    const day = actualDate && actualDate.toString().split(' ')[2]
    const year = actualDate && actualDate.toString().split(' ')[3]
    const stringTime = date && date.toString().split(' ')[4]  || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
